...
from tut8.myApp.sample import is_eligible_for_degree
...
@pytest.mark.parametrize("dummy_student,expected", [(19, False), (21, True)], indirect=["dummy_student"], ids=["Ineligible", "eligible"])
